...
import {
    getFormFactor, setCurrentFormFactor,
    deleteFormFactor
...
class FormFactorContainer extends React.Component {
    ...
    delete = () => {
        let res = window.confirm(`Вы действительно хотите удалить ${this.props.currentType.formFactor}`)
        if (res) {
...
export default connect(mapStateToProps, {
    getFormFactor, setCurrentFormFactor,
    setFormFactorVisinility, deleteFormFactor
})(FormFactorContainer)
