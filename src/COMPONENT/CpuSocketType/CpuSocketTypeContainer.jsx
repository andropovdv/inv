...
import {
    getSocketCpuData, setCurrentSocketCpu,
    setError, updateSocketCpuData, addSocketCpuData,
    deleteSoketCpuData
...
class CpuSocketTypeContainer extends React.Component {
    ...
    deleteTypeSocket = () => {
        let result = window.confirm(`Вы действительно хотите удалить разъем 
